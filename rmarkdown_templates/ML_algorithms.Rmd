...
set.seed(49043)
inTrain <- createDataPartition(lgbti_ML$open_at_work, 
                               p = .7, 
                               list = FALSE, 
                               times = 1)
...
roc_cart <- roc(lgbti_test$open_at_work, p_cart$Open) 

roc_rf  <- roc(lgbti_test$open_at_work, p_rf$Open) 
...
ggroc(list("logit" = roc_logit ,"cart" = roc_cart,"rf" = roc_rf)) +
  geom_segment(aes(x = 1, xend = 0, y = 0, yend = 1), color = "grey", linetype = "dashed") +
   labs( subtitle = "ROC-AUC for the three classification models")
...
confusionMatrix(c_cart, lgbti_test$open_at_work, mode = "everything", positive = "Open")
confusionMatrix(c_rf, lgbti_test$open_at_work, mode = "everything", positive = "Open")
